...
public class FaceController {
    ...
    public Result<Object> faceAdd(@RequestParam("file") String file, @RequestParam("groupId") Integer groupId, @RequestParam("name") String name) {
        ...
        try {
            ...
            logger.info("age:" + processInfoList.get(0).getAge());
            logger.info("gender:"+ (processInfoList.get(0).getGender().equals(1) ? "女" : "男"));
            logger.info("is_alive:" + processInfoList.get(0).getAlive());


            return Results.newSuccessResult("", processInfoList.get(0).getAge(), (processInfoList.get(0).getGender()), processInfoList.get(0).getAlive());
        } catch (Exception e) {
            logger.error("", e);
        }
    ...
    public Result<FaceSearchResDto> faceSearch(String file, Integer groupId) throws Exception {
        ...
        if (CollectionUtil.isNotEmpty(userFaceInfoList)) {
            ...
            return Results.newSuccessResult(faceSearchResDto, null, null, null);
        }
