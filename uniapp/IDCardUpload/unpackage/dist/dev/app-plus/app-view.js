...
Z([3,'grace-idcard-desc'])
Z([3,'描述示例文本 : graceUI  极速开发之旅 ! 基于 uni-app 的优秀前端框架，大幅度提高布局效率!'])
Z([3,'\n http://grace.hcoder.net'])
Z([3,'grace-idcard-text'])
Z([3,'身份证照片 ( 正面 )'])
...
Z(z[7])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'uploadCards']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'primary'])
Z([3,'上传'])
...
var lK=_mz(z,'view',['bindtap',7,'class',1,'data-event-opts',2],[],e,s,gg)
var aL=_n('view')
_rz(z,aL,'class',10,e,s,gg)
var tM=_mz(z,'image',['mode',11,'src',1],[],e,s,gg)
_(aL,tM)
_(lK,aL)
var eN=_n('view')
...
var xQ=_mz(z,'image',['bindtap',16,'data-event-opts',1,'mode',2,'src',3],[],e,s,gg)
_(oP,xQ)
_(oJ,oP)
_(xC,oJ)
var oR=_n('view')
...
var hU=_mz(z,'view',['bindtap',23,'class',1,'data-event-opts',2],[],e,s,gg)
var oV=_n('view')
_rz(z,oV,'class',26,e,s,gg)
var cW=_mz(z,'image',['mode',27,'src',1],[],e,s,gg)
_(oV,cW)
_(hU,oV)
var oX=_n('view')
...
var t1=_mz(z,'image',['bindtap',32,'data-event-opts',1,'mode',2,'src',3],[],e,s,gg)
_(aZ,t1)
_(cT,aZ)
_(xC,cT)
var e2=_n('view')
_rz(z,e2,'style',36,e,s,gg)
var b3=_mz(z,'button',['bindtap',37,'data-event-opts',1,'type',2],[],e,s,gg)
